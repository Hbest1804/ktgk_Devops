            ...
            <div className="flex items-center gap-4">
              {isLoggedIn ? (
                <div className="flex items-center gap-4">
                  ...
                  <Link to="/profile" className="text-gray-300 hover:text-white transition-colors" title="Profile">
                ...
                <Link to="/login" className="bg-red-600 hover:bg-red-700 text-white px-4 py-1.5 rounded-md text-sm font-medium transition-colors">
                  Sign In
                </Link>
              )}
            </div>
